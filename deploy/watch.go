...
func Autobuild(files []string, isgenerate bool) {
	...
	if err == nil {
		...
		// /usr/local/go/bin/go build -o "/Applications/IntelliJ IDEA 15.app/Contents/bin/jex/cn/longGoWeb/bin/Unnamed" -gcflags "-N -l" jex/cn/longGoWeb
		// "/Users/justinh/Library/Application Support/IntelliJIdea15/Go/lib/dlv/mac/dlv" --listen=localhost:52048 --headless=true exec "/Applications/IntelliJ IDEA 15.app/Contents/bin/jex/cn/longGoWeb/bin/Unnamed" --


		//args = append(args, `-gcflags "-N -l"`) //justin.j add ---debug
